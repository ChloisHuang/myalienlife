...
test('crossing days never grows a spirit tree, even with zero random rolls',()=>{
 const g=quietGame();g.civilization.discoveryPath=['eva','spore'];g.civilization.visits.spore=1;
...
test('existing spirit trees survive reload and remain available for prayer',()=>{
 const g=quietGame(),tree={id:'existing-tree',type:'spiritTree',x:-9,z:5,rotation:0,island:'eva',side:'front',fixed:true};g.objects.push(tree);
