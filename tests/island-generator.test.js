...
test('new exploration generates only remote blueprints and never replaces home furniture or occupants',()=>{
 ...
 g.civilization.discoveryPath=['home','spore','city'];g.civilization.visits.city=1;g.civilization.observations=12;contributeCivilization(g,'observe',{island:'city'},undefined,undefined,()=>0);g.civilization.visits['wild-0']=1;contributeCivilization(g,'observe',{island:'wild-0'},undefined,undefined,()=>0);
