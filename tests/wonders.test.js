...
test('relic progresses in chapters with cooldown, unlocks a bounded expedition',()=>{
 ...
 o.wonder.nextStudy=0;perform(g,'decodeRelic',o);o.wonder.nextStudy=0;perform(g,'restoreMemory',o);assert.equal(g.wonders.archive,3);assert.equal(enqueue(g,'traceRelic',o.id).ok,false);
