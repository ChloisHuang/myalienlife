...
import {environmentPreferenceSummary} from './island-preferences.js';
...
function refreshProjectMenu(){
 ...
 if(!workbench(o)||!project&&islandOf(o)!=='home')return;
