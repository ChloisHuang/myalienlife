...
export async function buildRelease(){
 ...
 await build({entryPoints:[resolve(root,'server/production.js'),resolve(root,'server/preflight.js')],outdir:directory,bundle:true,platform:'node',format:'esm',target:'node24',outExtension:{'.js':'.mjs'}});
